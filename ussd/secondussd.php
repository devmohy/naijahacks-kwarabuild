			...
			switch ($userResponse) {
			    case "":
			        if($level==0){
						...
						$response = "CON Welcome to Kwagric " . $userAvailable['name']  . ". Choose a service.\n";
			    ...
			    case "0":
			        if($level==0){
			        	...
			        	$db->query($sql9b);
			        	//Serve our services menu
						$response = "CON Welcome to Kwagric, " . $userAvailable['username']  . ". Choose a service.\n";
						$response .= " 1. Please call me.\n";
						$response .= " 2. Deposit\n";
						$response .= " 3. Withdraw\n";
						$response .= " 4. Send Money\n";							
		...
		if($userResponse==""){
			...
			switch ($level) {
			    ...
			    case 2:
					...
					$response = "CON Role not supposed to be empty. Please reply with your city \n";
			  		// Print the response onto the page so that our gateway can read it
			  		header('Content-type: text/plain');
 			  		echo $response;	
			        break;
			 case 3:
			    	//10f. Request for city again --- level has not changed...
					$response = "CON Address not supposed to be empty. Please reply with your city \n";
			  		// Print the response onto the page so that our gateway can read it
			  		header('Content-type: text/plain');
 			  		echo $response;	
			        break;
